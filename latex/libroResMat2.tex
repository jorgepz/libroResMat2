...
%\fancyfoot[R]{\thepage}
\fancyfoot[C]{\scriptsize{Material en revisión, publicar errores/sugerencias en \href{https://gitlab.fing.edu.uy/jorgepz/codigoFuenteLibroR2/-/issues}{gitlab.fing.edu.uy/jorgepz/codigoFuenteLibroR2/-/issues}.}}
%\headrulewidth 0.4pt
%\footrulewidth 0 pt
%\renewcommand{\headrulewidth}{0pt}

% bash: wget https://raw.githubusercontent.com/jorgepz/myLaTeXDefinitions/master/definitions.tex
...
%\input{Cap5_PEsp}
%\input{Cap6_AnaliSecc}
%\input{Cap7_Estabilidad}
%\input{Cap7_Inestabilidad_Otros}
%\input{Cap8_Losas}
