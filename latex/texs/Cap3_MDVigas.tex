...
%En clase se resolvió un ejemplo considerando deformación por esfuerzos axiales y se mostró que, en ese caso particular, la hipótesis de rigidez a directa es razonable. %
%
...
%\subsection{Ejemplo}
%
%PNI 20 3x3x3 carga 400 kg/m2
% Resolviendo usando ONSAS se tiene
...
\begin{center}
	\def\svgwidth{0.45\textwidth}
	c) \input{figs/UT3/UT3ejDespc.pdf_tex}
	\def\svgwidth{0.45\textwidth}
	d) \input{figs/UT3/UT3ejDespd.pdf_tex}	
\end{center}
