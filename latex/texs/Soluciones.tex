...
\begin{enumerate}
	\item aplicando que cada barra restringe su deformación axial, se puede determinar como incógnitas, los giros nodales y el desplazamiento axial del piso C-D.
	\item los valores normalizados son $\theta_C =-2 .15 \times 10^{-9}  \times $ \, EI rad/(Nm$^2$) , $\theta_D = -4 .12 \times 10^{-9}  \times $ EI \, rad/(Nm$^2$)  y $\Delta_x = -5.09\times 10^{-8}  \times $ EI \, m/(Nm$^2$),
\end{enumerate}
%
donde el valor numérico de EI, debe ser ingresado en Nm$^2$.
