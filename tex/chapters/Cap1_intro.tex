...
%
\begin{equation}
\int_{\Omega} \bfsig : \bfvarep (\bfw) dV = \int_{\Gamma_t}  \hat{\bft} \cdot \bfw d S + \int_{\Omega} \bfb \cdot \bfw dV,
\end{equation}
%
...
Esta relación permite plantear el problema de encontrar $\bfsig$ como el problema de encontrar cuál es el campo tensorial que verifica la igualdad anterior para cualquier campo de desplazamientos virtuales.

\begin{equation}
\int_{\Omega} \bfsig : \bfvarep (\bfw) dV = \int_{\Gamma_t}  \hat{\bft} \cdot \bfw d S + \int_{\Omega} \bfb \cdot \bfw dV \qquad \forall \bfw \in \mcV_{u}
\end{equation}
%
...
%
\begin{equation}
\int_{\Omega} \bbC[ \bfvarep (\bfu)] : \bfvarep (\bfw) dV = \int_{\Gamma_t}  \hat{\bft} \cdot \bfw d S + \int_{\Omega} \bfb \cdot \bfw dV \qquad \forall \bfw \in \mcV_{u}.
\end{equation}
